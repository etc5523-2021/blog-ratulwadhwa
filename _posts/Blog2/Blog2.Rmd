...
More over with the increase in the number of cases in India, People started giving up on the cliche cash mode of payment and adopted the digital mode to reduce the spread of the virus.
...
@sparkline, @DT, @tidyverse, @dplyr, @formattable, @readr, @ggplot2, @tidyquant, @ggpubr

https://www.kaggle.com/anishreddyindupuru/upi-trend-basis-demontization-and-corona
...
https://www.kaggle.com/sumandey/national-stock-exchange-banking-sectors?select=NSE_BANKING_SECTOR.csv
https://theprint.in/economy/lockdown-sees-more-than-a-million-new-stock-traders-in-india/422873/
