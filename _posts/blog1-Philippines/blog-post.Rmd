...
description: |
  In this post we will explore how covid'19 statistics in Philippines. The total number of cases, deaths and recovery and the total vaccinated so far. Apart from that we will also explore the govenments' covid stringency index in the Philippines.
author:
  - name: Ratul Wadhwa
...
## References
  ...
  Rami Krispin and Jarrett Byrnes (2021). coronavirus: The 2019 Novel Coronavirus COVID-19 (2019-nCoV) Dataset. R package version
  0.3.22. https://CRAN.R-project.org/package=coronavirus
  
  Ritchie, H. (2020, March 5). Philippines: Coronavirus Pandemic Country Profile. Our World in Data. https://ourworldindata.org/coronavirus/country/philippines
